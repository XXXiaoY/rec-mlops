...
class TestRecommendationAPI:
    ...
    def test_get_recommendations_success(self, mock_cache, mock_engine):
        ...
        response = client.post(
            "/recommendations",
            json={"user_id": 123, "num_recommendations": 3, "algorithm": "hybrid"},
        )
    ...
    def test_get_recommendations_cache_hit(self, mock_cache):
        ...
        # Mock cache hit
        cached_recommendations = [{"item_id": 1, "score": 0.95, "algorithm": "hybrid"}]
        mock_cache.get.return_value = cached_recommendations

        response = client.post(
            "/recommendations",
            json={"user_id": 123, "num_recommendations": 1, "algorithm": "hybrid"},
        )
    ...
    def test_get_recommendations_invalid_input(self):
        ...
        response = client.post(
            "/recommendations",
            json={"user_id": 123, "num_recommendations": 10, "algorithm": "invalid_algorithm"},
        )
        ...
        response = client.post(
            "/recommendations",
            json={"user_id": 123, "num_recommendations": 0, "algorithm": "hybrid"},
        )
        assert response.status_code == 422
    ...
    def test_record_interaction_success(self, mock_engine):
        ...
        response = client.post(
            "/interactions",
            json={"user_id": 123, "item_id": 456, "rating": 4.5, "interaction_type": "rating"},
        )
    ...
    def test_get_system_stats(self, mock_engine):
        ...
        mock_stats = {
            ...
            "model_metrics": {"svd": {"rmse": 0.84, "ndcg_10": 0.78}, "nmf": {"coverage": 0.942}},
        }
